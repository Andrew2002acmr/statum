...
| ------------------- | ---------------- | ----------------------------------------------- | --------------------------------------------------- | ------------------------ | ----------------------------------------------------------------------------------- | ------------------------------------------------- | ------------------ | ------------------------------- |
| `hero-main`         | Hero             | Основное интерьерное изображение первого экрана | `public/images/placeholders/hero-main.webp`         | `16:10` или шире `2.2:1` | Desktop: правая визуальная колонка; mobile: после текста, без зависимости от высоты | decorative до появления утверждённого изображения | placeholder-in-use | `[Макет]` `[Материалы]`         |
